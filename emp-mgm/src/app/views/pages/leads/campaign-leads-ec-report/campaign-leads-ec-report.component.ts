...
@Component({
  selector: 'app-campaign-leads-ec-report',
  templateUrl: './campaign-leads-ec-report.component.html',
  styleUrls: ['./campaign-leads-ec-report.component.scss']
})
export class CampaignLeadsEcReportComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.displayedColumns = ['teamname', 'teamlead', 'teamleadname', 'leadowner', 'leadownername', 'assigned', 'unassigned', 'unattempted', 'attempted', 'retarget', 'demo_given'];
    this.displayedColumns2 = ['teamname', 'teamlead', 'teamleadname', 'leadowner', 'leadownername', 'assigned', 'unassigned', 'unattempted', 'attempted', 'retarget', 'demo_given'];
  ...
  async submit() {
    this.isLoading = true;
    await this.leadService.displaycampagnmemsLeadreports(this.campaignname, this.Lang, this.Level, this.startDate, this.endDate).toPromise()
      .then(res => {
